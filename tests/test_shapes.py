...
def test_cube():
    ...
    assert cube.__str__ == 'cube1'
    assert cube.__repr__ == 'cube1'
...
def test_cylinder():
    ...
    assert cylinder.__str__ == 'cylinder'
    ...
    assert cylinder.__str__ == 'cylinder1'
    assert cylinder.__repr__ == 'cylinder1'
...
def test_cone():
    ...
    assert cone.__str__ == 'cone1'
    assert cone.__repr__ == 'cone1'
...
def test_sphere():
    ...
    assert sphere.__str__ == 'sphere1'
    assert sphere.__repr__ == 'sphere1'
...
def test_circle():
    ...
    assert circle.__str__ == 'circle1'
    assert circle.__repr__ == 'circle1'
...
def test_mesh():
    ...
    mesh = Mesh('mesh', points=point_list, \
                               color='green', origin=[0,0,0])                     
    assert mesh_shape.name == 'mesh'
    assert mesh_shape.__str__ == 'mesh'
    ...
    assert mesh_shape.__str__ == 'mesh1'
    assert mesh_shape.__repr__ == 'mesh1'
...
def test_plane():
    ...
    assert plane.__str__ == 'plane1'
    assert plane.__repr__ == 'plane1'
...
def test_tetrahedron():
    ...
    assert tetrahedron.__str__ == 'tetrahedron'
    ...
    assert tetrahedron.__str__ == 'tetrahedron1'
    assert tetrahedron.__repr__ == 'tetrahedron1'
...
def test_octahedron():
    ...
    assert octahedron.__str__ == 'octahedron'
    ...
    assert octahedron.__str__ == 'octahedron1'
    assert octahedron.__repr__ == 'octahedron1'
...
def test_icosahedron():
    ...
    assert icosahedron.__str__ == 'icosahedron1'
    assert icosahedron.__repr__ == 'icosahedron1'
...
def test_torus():
    ...
    assert torus.__str__ == 'torus1' 			
    assert torus.__repr__ == 'torus1' 			
...
def test_tube():
    ...
    assert tube.__str__ == 'tube1' 			
    assert tube.__repr__ == 'tube1' 			
...
def test_torus_knot():
    ...
    assert torus_knot.__str__ == 'torus_knot' 			
    assert torus_knot.__repr__ == 'torus_knot' 			
    ...
    assert torus_knot.__str__ == 'torus_knot1' 			
    assert torus_knot.__repr__ == 'torus_knot1' 			
