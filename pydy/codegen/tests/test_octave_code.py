...
% input_3 : [c0, c1, c2, k0, k1, k2, m0, m1, m2]
    ...
    pydy_5 = -input_3(9);
    pydy_6 = input_3(9).*pydy_4;
    pydy_7 = -pydy_3.*pydy_6 - pydy_5;
    pydy_8 = 1./(-pydy_3.^2.*pydy_4 + pydy_3);
    pydy_9 = input_3(1).*pydy_0 + input_3(4).*input_1(1);
    pydy_10 = -pydy_9;
    pydy_11 = input_3(2).*pydy_1 + input_3(5).*input_1(2) + ...
    pydy_10.*pydy_3.*pydy_4;
    pydy_12 = (-input_3(3).*pydy_2 - input_3(6).*input_1(3) - ...
    pydy_10.*pydy_6 + pydy_11.*pydy_7.*pydy_8)./(-input_3(9).^2.*pydy_4 - ...
    pydy_5 - pydy_7.^2.*pydy_8);
    pydy_13 = pydy_8.*(-pydy_11 - pydy_12.*pydy_7);

    output_1 = [pydy_0; pydy_1; pydy_2; pydy_4.*(-input_3(9).*pydy_12 - ...
    pydy_13.*pydy_3 - pydy_9); pydy_13; pydy_12];
...
"""
    ...
    if parse_version(SYMPY_VERSION) >= parse_version('1.10'):
        assert g.doprint() == expected_m_file_1p10
