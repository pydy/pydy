...
# SymPy >= 1.1 outputs different cse results, same for 1.1 and 1.2.
    expected_m_file_1p1_1p2 = """\
function [output_1] = eval_mats(input_1, input_2, input_3)
% function [output_1] = eval_mats(input_1, input_2, input_3)
%
% input_1 : [x0(t), x1(t), x2(t)]
...
"""
    ...
    if parse_version(SYMPY_VERSION) >= parse_version('1.1'):
        assert g.doprint() == expected_m_file_1p1_1p2
