...
%           distance bx and bz from the rear wheel center, as reported by
%           the IMU. (includes gravity!)
%   Q_acc - Body fixed linear acceleration of a point Q on the front frame,
%           distance ex and ez from the front wheel center, as reported by
%           the IMU. (includes gravity!)
    ...
    res = eval_imu([q4, q5, q7], ...
                   [u3, u4, u5, u6, u7], ...
                   [u3p, u4p, u5p, u6p, u7p], ...
                   [p.bx, p.bz, p.d1, p.d2, p.d3, p.ex, p.ez, p.g, lam, p.rr]);
